    ...
    <div class="column is-one-third is-offset-one-third m-t-100">
        <div class="card">
            <div class="card-content">
                ...
                <form class="form" action={{route('register')}} method="POST" role="form">
                    {{csrf_field()}}

                    <div class="field">
                        <label for="name" class="label">Name</label>
                        <p class="control">
                            <input class="input {{ $errors->has('name') ? ' is-danger' : '' }}" type="text" name="name" id="name" placeholder="First Last" value="{{ old('name') }}" required>
                        </p>
                        @if ($errors->has('name'))
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <div class="field">
                                ...
                                <p class="control">
                                    <input class="input {{ $errors->has('password') ? ' is-danger' : '' }}" type="password" name="password_confirmation" id="password-confirm" required>
                                </p>
                            </div>
                        </div>
                    </div>
