    ...
    <div class="column is-one-third is-offset-one-third m-t-100">
        <div class="card">
            <div class="card-content">
                ...
                <form class="form" action={{route('password.request')}} method="POST" role="form">
                    {{csrf_field()}}
        ...
        <h5 class="has-text-centered m-t-20"><a href="{{route('login')}}" class="is-muted"><span class="icon"><i class="fa fa-caret-left"></i></span>Back to log in</a></h5>
    </div>
</div>
